...
Vetted 10 files [presence, enrichment, freshness, coverage] — 2 findings (2 required, 0 recommended), 87.0% coverage. (0.3s)
```
...
Vetted 10 files [presence, enrichment, freshness, coverage] — 1 finding (1 required, 0 recommended), 87.0% coverage. (0.3s)
```
